<template>
	<view class="index">
		...
		<view style="margin-top: calc(176rpx + 16rpx);" class="nav2 nav3 nav4">
			<view class="n2-box">
				<view class="n2b-tit1">招聘企业<text class="red">*保护猎企权益，严禁实名制</text></view>
				<view class="n2b-tit2" @click="toGangwei">
					<u-input :clearable='false' placeholder='请输入对外显示名称' v-model="value" type="text" />
					<!-- <u-icon name="play-right-fill" color="#000000" size="20"></u-icon> -->
				</view>
				<view style="margin-top: 0;" class="heng"></view>
				<view style="margin-top: 46rpx;" class="n2b-tit1">内部识别名称</view>
				<view class="n2b-tit2" @click="toGangwei">
					<u-input :clearable='false' placeholder='仅内部可见' v-model="value" type="text" />
					<!-- <u-icon name="play-right-fill" color="#000000" size="20"></u-icon> -->
				</view>
				<view style="margin-top: 0;" class="heng"></view>
